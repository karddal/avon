...
async def create_unit(unit: UnitCreate, session: session_dependency):
  ...
  db_unit = Unit(name=unit.name, description=unit.description, unit_code=unit.unit_code)
...
async def get_user_units(user_id:UUID, session: session_dependency):
  ...
  for enrollment in enrollments:
    ...
    for unit in units:
      response_unit = UnitRead(name=unit.name, description=unit.description, creation_date=unit.creation_date, unit_code=unit.unit_code)
