...
function buildEventsMap(mondayKey: string) {
    const events: CalendarEvent[] = [
        makeEvent("event1", "Event 1", mondayKey+"T09:00:00", mondayKey+"T10:00:00"),
        makeEvent("event2", "Event 2", mondayKey+"T09:00:00", mondayKey+"T10:00:00"),
        makeEvent("event3", "Event 3", mondayKey+"T09:00:00", mondayKey+"T10:00:00"),
        makeEvent("event4", "Event 4", mondayKey+"T09:00:00", mondayKey+"T10:00:00"),
    ]
...
describe ("calendar-timetable-card (component test)", () => {
    ...
    it("renders current time line when today is in the visible days", () => {
        ...
        cy.get("div").contains(/\b\d{2}:\d{2}\b/).should("exist")
    })
})