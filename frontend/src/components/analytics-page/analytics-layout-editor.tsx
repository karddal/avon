...
type AnalyticsLayoutEditorProps = {
...
function getModuleConstraints(moduleKey: AnalyticsModuleKey) {
  const moduleDef = analyticsModuleRegistry[moduleKey];
...
export default function AnalyticsLayoutEditor({
  availableModules,
  layout,
  onChange,
}: AnalyticsLayoutEditorProps) {
  ...
  function addModule(moduleKey: AnalyticsModuleKey) {
    setLayout((prev) => {
                          ...
                          remainingModules.map((moduleKey) => (
                            ...
                            >
                              ...
                              <span className="text-xs font-medium">
                                {analyticsModuleRegistry[moduleKey]?.title ??
                                  moduleKey}
                              </span>
                            </Card>
                          ))
            ...
            <div className="flex flex-1 items-start justify-center overflow-auto border bg-background p-4">
              ...
              >
                {layout.length === 0 ? (
                  ...
                  layout.map((item) => {
                    const moduleDef = analyticsModuleRegistry[item.moduleKey];
                    const previewItem =
                      ...
                      >
                        <div className="flex h-full flex-col">
                          ...
                          <div className="relative flex flex-1 items-center justify-center p-2 text-xs text-muted-foreground">
                            ...
                            >
                              <span className="pointer-events-none absolute bottom-[1px] right-[1px] text-[8px] leading-none">
                                ◢
                              </span>
                            </button>
                          </div>
