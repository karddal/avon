...
import { analyticsModuleRegistry } from "@/components/analytics-page/analytics-module-registry";
import type { GridItem } from "@/components/analytics-page/analytics-types";
import { cn } from "@/lib/utils";

type AnalyticsRendererProps = {
  layout: GridItem[];
};
...
export default function AnalyticsRenderer({ layout }: AnalyticsRendererProps) {
