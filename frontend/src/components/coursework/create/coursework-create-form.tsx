...
import {FormProps} from "@/components/coursework/create/types";
        ...
        <div className="flex w-full justify-center p-6 md:p-8">
            <div className="w-full max-w-3xl">
                <Card className="w-full border-0 text-base shadow-none">
                    <Progress value={getStepProgress(courseworkForm.step)} className="rounded-none" />
                        ...
                        <CardDescription>
                            ...
                            {courseworkForm.selectedUnitData ? (
                                <>
                                    ...
                                    >
                                        <span className="font-mono">{courseworkForm.selectedUnitData.unit_code}</span>{" "}
                    ...
                    <CardContent className="flex h-full flex-col content-between justify-between">
                        <form id="form-flow" onSubmit={courseworkForm.form.handleSubmit(courseworkForm.onSubmit)}>
                                ...
                                {courseworkForm.step === "details" && (
                                    ...
                                    >
                                        <CourseworkDetailsStep
                                            ...
                                            onNext={() => {
                                                void courseworkForm.validateDetailsStep().then((valid) => {
