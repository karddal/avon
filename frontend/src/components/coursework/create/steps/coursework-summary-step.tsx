...
import type {UnitData, UnitOption} from "@/components/coursework/create/types";
                    ...
                    <ItemContent>
                        ...
                        <ItemDescription>
                            {selectedUnitData ? (
                                ...
                                <>
                                    <span className="font-mono">{selectedUnitSummary.unit_code}</span>{" "}
                        ...
                        <ItemDescription>{dueDate ? dueDate.toString() : "Not provided."}</ItemDescription>
