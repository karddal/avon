...
import {columns, StudentNameAndPotentiallyRepo} from "@/components/coursework/student-list/columns";
                            ...
                            <TableCell key={cell.id}>
                              {cell.getIsGrouped() ? (
                                  <>
                                    ...
                                    >
                                      {row.getIsExpanded() ? <CornerRightDown/> : <ArrowRight/>}{' '}
                                      {flexRender(
