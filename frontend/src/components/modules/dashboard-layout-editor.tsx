...
function getModuleConstraints(moduleKey: DashboardModuleKey) {
  const moduleDef = dashboardModuleRegistry[moduleKey];
...
export default function DashboardLayoutEditor({
  ...
  function addModule(moduleKey: DashboardModuleKey) {
    setLayout((prev) => {
                          ...
                          remainingModules.map((moduleKey) => (
                            ...
                            >
                              ...
                              <span className="text-xs font-medium">
                                {dashboardModuleRegistry[moduleKey]?.title ??
                                  moduleKey}
                              </span>
                            </Card>
                          ))
            ...
            <div className="flex flex-1 items-start justify-center overflow-auto border bg-background p-4">
              ...
              >
                {layout.length === 0 ? (
                  ...
                  layout.map((item) => {
                    const moduleDef = dashboardModuleRegistry[item.moduleKey];
                    const previewItem =
