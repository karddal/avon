...
import { dashboardModuleRegistry } from "@/components/modules/dashboard-module-registry";
...
export default function DashboardRenderer({ layout }: DashboardRendererProps) {
