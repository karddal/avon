...
function getModuleConstraints(moduleKey: UnitModuleKey) {
  const moduleDef = unitModuleRegistry[moduleKey];
...
export default function UnitLayoutEditor({
  availableModules,
  layout,
  onChange,
}: UnitLayoutEditorProps) {
  ...
  function addModule(moduleKey: UnitModuleKey) {
    setLayout((prev) => {
                          ...
                          remainingModules.map((moduleKey) => (
                            ...
                            >
                              ...
                              <span className="text-xs font-medium">
                                {unitModuleRegistry[moduleKey]?.title ??
                                  moduleKey}
                              </span>
                            </Card>
                          ))
