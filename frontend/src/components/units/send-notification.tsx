...
const formSchema = z.object({
  title: z.string().min(1, "Notification title must be at least 1 character long.")
      .max(60, "Notification title must not be more than 60 characters long."),

  body: z.string().min(1, "Notification body must not be empty.")
    ...
    <Dialog open={openState} onOpenChange={setOpenState}>
      <DialogContent className="max-h-[80%] md:overflow-auto overflow-y-scroll ">
        ...
        <DialogHeader>
          ...
          <DialogDescription>Here, you can send a notification to all the students on this unit.</DialogDescription>
        </DialogHeader>
          <FieldGroup>
            <Controller
              name={"title"}
            ...
            <Controller
                ...
                render={({ field, fieldState }) => (
                    <Field data-invalid={fieldState.invalid}>
                      <FieldLabel htmlFor="notification-form-body">
                        Body
                      </FieldLabel>
                      <InputGroup>
                        <InputGroupTextarea
